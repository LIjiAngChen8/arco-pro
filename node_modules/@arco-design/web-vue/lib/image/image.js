...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { attrs, slots, emit }) {
    ...
    vue.watchEffect((onInvalidate) => {
      var _a;
      const unRegister = (_a = groupContext == null ? void 0 : groupContext.registerImageUrl) == null ? void 0 : _a.call(groupContext, imageId, (src == null ? void 0 : src.value) || "", preview2.value);
      onInvalidate(() => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    ]), 1032, ["prefix-cls", "title", "description"])) : vue.createCommentVNode("v-if", true),
    ...
    }), null, 16, ["src", "visible", "render-to-body", "onClose"])) : vue.createCommentVNode("v-if", true)
  ], 6);
}
