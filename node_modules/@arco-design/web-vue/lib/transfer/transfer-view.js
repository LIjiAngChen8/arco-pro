  ...
  setup(props, { emit }) {
    ...
    const handleSelectAllChange = (checked2) => {
      if (checked2) {
        ...
        emit("selectChange", props.selected.filter((value) => !props.dataInfo.allValidValues.includes(value)));
      }
    };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createVNode(_component_list, { bordered: false }, {
      default: vue.withCtx(() => [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.filteredData, (item) => {
          ...
          }, null, 8, ["type", "data", "simple", "allow-clear", "onSelectChange"]);
        }), 128))
      ]),
      _: 1
    })
