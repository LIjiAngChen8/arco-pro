...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const radioGroupCtx = vue.inject(context.radioGroupKey, void 0);
    ...
    const mergedDisabled = vue.computed(() => (radioGroupCtx == null ? void 0 : radioGroupCtx.disabled) || props.disabled);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("span", {
    ...
    _ctx.mergedType === "radio" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
      ...
      key: 1,
      class: vue.normalizeClass(`${_ctx.prefixCls}-button-content`)
    }, [
      vue.renderSlot(_ctx.$slots, "default")
    ], 2))
  ], 2);
}
var _Radio = /* @__PURE__ */ pluginVue_exportHelper(_sfc_main, [["render", _sfc_render]]);
