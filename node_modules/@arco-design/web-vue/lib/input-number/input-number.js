...
var index$4 = require("../icon/icon-up/index.js");
var index$5 = require("../icon/icon-down/index.js");
var index$3 = require("../icon/icon-plus/index.js");
var index$2 = require("../icon/icon-minus/index.js");
...
const InputGroup = index["default"].Group;
...
var _InputNumber = vue.defineComponent({
  ...
  setup(props, {
    ...
    const renderSuffix = () => {
      ...
      return vue.createVNode(vue.Fragment, null, [(_a2 = slots.suffix) == null ? void 0 : _a2.call(slots), vue.createVNode("div", {
      ...
      }, [vue.createVNode(index$4, null, null)]), vue.createVNode("button", {
        "class": [`${prefixCls}-step-button`, {
        ...
        "onMouseup": clearRepeatTimer,
        "onMouseleave": clearRepeatTimer
      }, [vue.createVNode(index$5, null, null)])])]);
    };
    const cls = vue.computed(() => [prefixCls, `${prefixCls}-mode-${props.mode}`, `${prefixCls}-size-${props.size}`]);
    const renderInput = () => {
      const inputSlots = props.mode === "embed" && !props.hideButton ? __spreadProps(__spreadValues({}, slots), {
        suffix: renderSuffix
      }) : slots;
      return vue.createVNode(index["default"], vue.mergeProps(attrs, {
        "ref": inputRef,
        "class": cls.value,
        "type": "text",
        "size": props.size,
    ...
    const render = () => {
      ...
      return vue.createVNode(InputGroup, null, {
        default: () => [vue.createVNode(index$1["default"], {
          ...
          icon: () => vue.createVNode(index$2, null, null)
        }), renderInput(), vue.createVNode(index$1["default"], {
          "size": props.size,
          "disabled": props.disabled || isMax.value,
          "onMousedown": (e) => handleStepButton(e, "plus", true),
          "onMouseup": clearRepeatTimer,
