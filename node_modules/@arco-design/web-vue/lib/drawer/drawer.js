...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const containerNode = vue.computed(() => {
      const ele = dom.getElement(props.popupContainer);
          ...
          vue.withDirectives(vue.createElementVNode("div", {
            ...
            _ctx.footer ? (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.renderSlot(_ctx.$slots, "footer", {}, () => [
                vue.createVNode(_component_arco_button, vue.mergeProps(_ctx.cancelButtonProps, { onClick: _ctx.handleCancel }), {
                  default: vue.withCtx(() => [
