...
const _sfc_main = vue.defineComponent({
  ...
  setup(props) {
    ...
    const node = vue.computed(() => {
      var _a;
      return (_a = treeContext.key2TreeNode) == null ? void 0 : _a[key.value];
    });
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("span", {
      ...
      _ctx.$slots.icon || _ctx.icon ? (vue.openBlock(), vue.createElementBlock("span", {
        key: 0,
        class: vue.normalizeClass([`${_ctx.prefixCls}-icon`, `${_ctx.prefixCls}-custom-icon`])
      }, [
        vue.createCommentVNode(" @slot \u8282\u70B9\u56FE\u6807 "),
        _ctx.$slots.icon ? vue.renderSlot(_ctx.$slots, "icon", { key: 0 }) : (vue.openBlock(), vue.createBlock(_component_RenderFunction, {
          key: 1,
      ...
      vue.createElementVNode("span", {
        ...
        _ctx.treeTitle ? (vue.openBlock(), vue.createBlock(_component_RenderFunction, {
          ...
          vue.createCommentVNode(" @slot \u6807\u9898\uFF0C\u4F18\u5148\u7EA7\u9AD8\u4E8E props \u7684 title "),
        ...
        _ctx.draggable ? (vue.openBlock(), vue.createElementBlock("span", {
          ...
          vue.createCommentVNode(" @slot \u62D6\u62FD\u56FE\u6807 "),
          ...
          }, null, 8, ["render-func"])) : (vue.openBlock(), vue.createBlock(_component_IconDragDotVertical, { key: 3 }))
        ], 2)) : vue.createCommentVNode("v-if", true)
      ], 2)
    ], 42, _hoisted_2),
