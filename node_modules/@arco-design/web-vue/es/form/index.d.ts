...
declare const Form: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "disabled" | "layout" | "labelColProps" | "wrapperColProps" | "labelAlign" | "autoLabelWidth">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
