...
declare const Slider: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            onChange?: import("../_utils/types").EmitType<(value: number | [number, number]) => void> | undefined;
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "modelValue" | "defaultValue" | "direction" | "range" | "step" | "max" | "min" | "showTicks" | "showInput">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
