...
declare const _default: import("vue").DefineComponent<{
    ...
    computedTreeProps: import("vue").ComputedRef<{
        ...
        allowDrop?: ((options: {
            dropNode: import("../tree/interface").TreeNodeData;
            dropPosition: import("../tree/interface").DropPosition;
        }) => boolean) | undefined;
        selectable?: boolean | undefined;
        checkStrictly?: boolean | undefined;
        checkedStrategy?: "all" | "child" | "parent" | undefined;
        ...
        onSelect?: ((selectedKeys: TreeNodeKey[], event: {
            selected: boolean;
            selectedNodes: import("../tree/interface").TreeNodeData[];
            node: import("../tree/interface").TreeNodeData;
            e: Event;
        }) => void) | undefined;
        onCheck?: ((checkedKeys: TreeNodeKey[], event: {
            checked: boolean;
            checkedNodes: import("../tree/interface").TreeNodeData[];
            node: import("../tree/interface").TreeNodeData;
            e: Event;
        }) => void) | undefined;
        onExpand?: ((expandedKeys: TreeNodeKey[], event: {
            expanded: boolean;
            expandedNodes: import("../tree/interface").TreeNodeData[];
            node: import("../tree/interface").TreeNodeData;
            e?: Event | undefined;
        }) => void) | undefined;
        onDragStart?: ((e: DragEvent, node: import("../tree/interface").TreeNodeData) => void) | undefined;
        onDragEnd?: ((e: DragEvent, node: import("../tree/interface").TreeNodeData) => void) | undefined;
        onDragOver?: ((e: DragEvent, node: import("../tree/interface").TreeNodeData) => void) | undefined;
        onDragLeave?: ((e: DragEvent, node: import("../tree/interface").TreeNodeData) => void) | undefined;
        onDrop?: ((event: {
            e: DragEvent;
            dragNode: import("../tree/interface").TreeNodeData;
            dropNode: import("../tree/interface").TreeNodeData;
            dropPosition: import("../tree/interface").DropPosition;
        }) => void) | undefined;
        filterTreeNode?: ((node: import("../tree/interface").TreeNodeData) => boolean) | undefined;
    }>;
