...
export declare const mergeFirstChild: (vns: VNode[], extraProps: Data | ((vn: VNode) => Data)) => boolean;
...
export declare const getAllElements: (vns: VNode[] | undefined) => VNode<import("vue").RendererNode, import("vue").RendererElement, {
    [key: string]: any;
}>[];
