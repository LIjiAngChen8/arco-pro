import { FileItem, RequestOption, UploadRequest } from './interfaces';
export declare const getProgressStatus: (status?: "done" | "error" | "init" | "uploading" | undefined) => "normal" | "success" | "danger";
...
export declare const getDataURLFromFile: (file: File) => Promise<string>;
