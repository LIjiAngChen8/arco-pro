...
.arco-btn-link.arco-btn-icon-only {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  vertical-align: top;
...
/** input， input number **/
.arco-form-item-status-validating .arco-input-wrapper:not(.arco-input-wrapper-disabled),
.arco-form-item-status-validating .arco-textarea:not(.arco-textarea-disabled) {
  background-color: var(--color-fill-2);
  border-color: transparent;
}
.arco-form-item-status-validating .arco-input-wrapper:not(.arco-input-wrapper-disabled):hover,
.arco-form-item-status-validating .arco-textarea:not(.arco-textarea-disabled):hover {
  background-color: var(--color-fill-3);
  border-color: transparent;
}
.arco-form-item-status-validating .arco-input-wrapper.arco-input-wrapper-focus,
.arco-form-item-status-validating .arco-input-wrapper.arco-textarea-focus,
.arco-form-item-status-validating .arco-textarea.arco-input-wrapper-focus,
.arco-form-item-status-validating .arco-textarea.arco-textarea-focus,
.arco-form-item-status-validating .arco-input-wrapper.arco-input-wrapper-focus:hover,
.arco-form-item-status-validating .arco-input-wrapper.arco-textarea-focus:hover,
.arco-form-item-status-validating .arco-textarea.arco-input-wrapper-focus:hover,
...
/** input， input number **/
.arco-form-item-status-success .arco-input-wrapper:not(.arco-input-wrapper-disabled),
.arco-form-item-status-success .arco-textarea:not(.arco-textarea-disabled) {
  background-color: var(--color-fill-2);
  border-color: transparent;
}
.arco-form-item-status-success .arco-input-wrapper:not(.arco-input-wrapper-disabled):hover,
.arco-form-item-status-success .arco-textarea:not(.arco-textarea-disabled):hover {
  background-color: var(--color-fill-3);
  border-color: transparent;
}
.arco-form-item-status-success .arco-input-wrapper.arco-input-wrapper-focus,
.arco-form-item-status-success .arco-input-wrapper.arco-textarea-focus,
.arco-form-item-status-success .arco-textarea.arco-input-wrapper-focus,
.arco-form-item-status-success .arco-textarea.arco-textarea-focus,
.arco-form-item-status-success .arco-input-wrapper.arco-input-wrapper-focus:hover,
.arco-form-item-status-success .arco-input-wrapper.arco-textarea-focus:hover,
.arco-form-item-status-success .arco-textarea.arco-input-wrapper-focus:hover,
...
/** input， input number **/
.arco-form-item-status-warning .arco-input-wrapper:not(.arco-input-wrapper-disabled),
.arco-form-item-status-warning .arco-textarea:not(.arco-textarea-disabled) {
  background-color: var(--color-warning-light-1);
  border-color: transparent;
}
.arco-form-item-status-warning .arco-input-wrapper:not(.arco-input-wrapper-disabled):hover,
.arco-form-item-status-warning .arco-textarea:not(.arco-textarea-disabled):hover {
  background-color: var(--color-warning-light-2);
  border-color: transparent;
}
.arco-form-item-status-warning .arco-input-wrapper.arco-input-wrapper-focus,
.arco-form-item-status-warning .arco-input-wrapper.arco-textarea-focus,
.arco-form-item-status-warning .arco-textarea.arco-input-wrapper-focus,
.arco-form-item-status-warning .arco-textarea.arco-textarea-focus,
.arco-form-item-status-warning .arco-input-wrapper.arco-input-wrapper-focus:hover,
.arco-form-item-status-warning .arco-input-wrapper.arco-textarea-focus:hover,
.arco-form-item-status-warning .arco-textarea.arco-input-wrapper-focus:hover,
...
/** input， input number **/
.arco-form-item-status-error .arco-input-wrapper:not(.arco-input-wrapper-disabled),
.arco-form-item-status-error .arco-textarea:not(.arco-textarea-disabled) {
  background-color: var(--color-danger-light-1);
  border-color: transparent;
}
.arco-form-item-status-error .arco-input-wrapper:not(.arco-input-wrapper-disabled):hover,
.arco-form-item-status-error .arco-textarea:not(.arco-textarea-disabled):hover {
  background-color: var(--color-danger-light-2);
  border-color: transparent;
}
.arco-form-item-status-error .arco-input-wrapper.arco-input-wrapper-focus,
.arco-form-item-status-error .arco-input-wrapper.arco-textarea-focus,
.arco-form-item-status-error .arco-textarea.arco-input-wrapper-focus,
.arco-form-item-status-error .arco-textarea.arco-textarea-focus,
.arco-form-item-status-error .arco-input-wrapper.arco-input-wrapper-focus:hover,
.arco-form-item-status-error .arco-input-wrapper.arco-textarea-focus:hover,
.arco-form-item-status-error .arco-textarea.arco-input-wrapper-focus:hover,
...
.arco-image-preview-toolbar-tooltip {
...
.arco-input-number-mode-embed.arco-input-wrapper:not(.arco-input-wrapper-focus) .arco-input-number-step-button:not(.arco-input-number-step-button-disabled):hover {
  background-color: var(--color-fill-4);
}
...
.arco-input-outer > .arco-input-wrapper-focus {
  border-radius: var(--border-radius-small);
}
...
.arco-input-group > .arco-select .arco-select-view {
  border-radius: 0;
}
.arco-input-group > * {
  border-radius: 0;
}
.arco-input-group > * .arco-input-group > :last-child,
.arco-input-group > * .arco-input-group > :first-child {
  border-radius: 0;
}
...
.arco-input-group > *:first-child .arco-input-group > *:first-child .arco-select .arco-select-view {
  border-top-left-radius: var(--border-radius-small);
  border-bottom-left-radius: var(--border-radius-small);
}
...
.arco-input-group > *:last-child .arco-select .arco-select-view,
.arco-input-group > *:last-child .arco-input-outer > *:last-child .arco-select .arco-select-view {
  border-top-right-radius: var(--border-radius-small);
  border-bottom-right-radius: var(--border-radius-small);
}
...
.arco-input-type-search .arco-input-group-addbefore {
  transition: all 0.1s cubic-bezier(0, 0, 1, 1);
}
.arco-input-type-search .arco-input-group-addafter {
  padding: 0;
  border: none;
}
.arco-input-type-search .arco-input-group-suffix {
  color: var(--color-text-2);
  font-size: 14px;
}
.arco-input-type-search:not(.arco-input-disabled) .arco-input-group-addbefore {
  color: var(--color-text-2);
  font-size: 14px;
  cursor: pointer;
}
.arco-input-type-search.arco-input-after-append .arco-input {
  border-right: none;
  border-top-right-radius: 0;
  border-bottom-right-radius: 0;
}
.arco-input-type-search .arco-input-search-btn {
  font-size: 14px;
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}
.arco-input-type-search .arco-input-search-btn.arco-btn-icon-only {
  padding-right: 8px;
  padding-left: 8px;
}
...
.arco-list-bordered .arco-list-header,
.arco-list-bordered .arco-list-item:not(:last-child) {
  border-bottom: 1px solid var(--color-neutral-3);
}
.arco-list-bordered .arco-list-footer {
  border-top: 1px solid var(--color-neutral-3);
}
.arco-list-bordered .arco-list-no-split .arco-list-header,
.arco-list-bordered .arco-list-no-split .arco-list-footer,
.arco-list-bordered .arco-list-no-split .arco-list-item {
  border: none;
}
.arco-list-header {
  color: var(--color-text-1);
...
.arco-slider-track-vertical .arco-slider-marks-text {
  transform: translateY(50%);
}
.arco-slider-dots {
  height: 100%;
...
.arco-table:not(.arco-table-has-fixed-col-left)-scroll-position-right .arco-table-content-scroll::before,
.arco-table:not(.arco-table-has-fixed-col-left)-scroll-position-middle .arco-table-content-scroll::before {
  box-shadow: inset 6px 0 8px -3px rgba(0, 0, 0, 0.15);
}
.arco-table:not(.arco-table-has-fixed-col-right)-scroll-position-left .arco-table-content-scroll::after,
.arco-table:not(.arco-table-has-fixed-col-right)-scroll-position-middle .arco-table-content-scroll::after {
  box-shadow: inset -6px 0 8px -3px rgba(0, 0, 0, 0.15);
}
.arco-table-layout-fixed .arco-table-container {
  overflow-x: auto;
  overflow-y: hidden;
}
...
.arco-table-hover .arco-table-tr:not(.arco-table-tr-empty):hover .arco-table-td:not(.arco-table-col-fixed-left):not(.arco-table-col-fixed-right) {
  background-color: var(--color-fill-1);
}
.arco-table-hover .arco-table-tr:not(.arco-table-tr-empty):hover .arco-table-td.arco-table-col-fixed-left::before,
.arco-table-hover .arco-table-tr:not(.arco-table-tr-empty):hover .arco-table-td.arco-table-col-fixed-right::before {
  position: absolute;
  top: 0;
  left: 0;
  z-index: -1;
