  ...
  "node_modules/@intlify/core-base/dist/core-base.cjs.js"(exports) {
    ...
    function getDefaultLinkedModifiers() {
      return {
        ...
        capitalize: (val) => shared.isString(val) ? `${val.charAt(0).toLocaleUpperCase()}${val.substr(1)}` : val
      };
    }
    var _compiler;
    ...
    function translate(context, ...args) {
      ...
      const defaultMsgOrKey = shared.isString(options.default) || shared.isBoolean(options.default) ? !shared.isBoolean(options.default) ? options.default : key : fallbackFormat ? !messageCompiler2 ? () => key : key : "";
